...
Nesta versão, admin e o servidor OAuth2/OIDC: as rotas do DOT entram sob `o/`, como vem,
sem namespace explícito — `oauth2_provider.urls` já declara o seu, e a discovery monta cada
...
urlpatterns = [
    ...
    # Sob prefixo, nunca na raiz: na raiz as views de gestão de applications e de tokens
    # cairiam no espaço de nomes do produto (ADR 0007).
